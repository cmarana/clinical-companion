    ...
    <div className="space-y-2.5">
      ...
      {lastMedication && (
        <button
          ...
          className="w-full flex items-center gap-3 p-3.5 rounded-2xl bg-card border border-border/60 hover:border-primary/30 hover:shadow-md active:scale-[0.99] transition-all text-left"
        >
          <div className="flex items-center justify-center w-10 h-10 rounded-xl shrink-0 bg-primary/10 text-primary dark:text-primary">
            <Pill size={18} />
          </div>
          <div className="flex-1 min-w-0">
            <p className="text-[10px] uppercase tracking-wider text-muted-foreground font-semibold">
      ...
      {pendingFlashcards > 0 && (
        <button
          ...
          className="w-full flex items-center gap-3 p-3.5 rounded-2xl bg-card border border-border/60 hover:border-destructive/40 hover:shadow-md active:scale-[0.99] transition-all text-left"
        >
          <div className="flex items-center justify-center w-10 h-10 rounded-xl shrink-0 bg-destructive/10 text-destructive dark:text-destructive">
            <Brain size={18} />
          </div>
          <div className="flex-1 min-w-0">
            <p className="text-[10px] uppercase tracking-wider text-muted-foreground font-semibold">
          ...
          <span className="inline-flex items-center gap-1 px-2.5 h-7 rounded-full bg-destructive/10 text-destructive dark:text-destructive text-[11px] font-semibold shrink-0">
