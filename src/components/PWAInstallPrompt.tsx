...
export function OfflineIndicator() {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-banner safe-area-top flex items-center justify-center gap-2 bg-destructive py-1.5 text-destructive-foreground text-xs font-medium">
