...
export const HIGH_RISK_PAIRS: Record<string, InteractionPair[]> = {
  ...
  // ── Carbapenêmicos ──
  "meropenem": [
    { drugs: ["ácido valproico", "valproato"], severity: "grave", desc: "Carbapenêmicos reduzem níveis de valproato em 60-100% — convulsões. Contraindicado." },
    { drugs: ["probenecida"], severity: "moderado", desc: "Probenecida aumenta meia-vida de meropenem — geralmente não recomendado." },
    { drugs: ["ciclosporina"], severity: "moderado", desc: "Risco de neurotoxicidade aditiva." },
  ],
  "imipenem": [
    { drugs: ["ácido valproico", "valproato"], severity: "grave", desc: "Redução drástica de níveis de valproato — risco de convulsões. Contraindicado." },
    { drugs: ["ganciclovir"], severity: "grave", desc: "Risco de convulsões aditivo — evitar combinação." },
    { drugs: ["ciclosporina"], severity: "moderado", desc: "Neurotoxicidade aditiva — monitorar sinais neurológicos." },
    { drugs: ["teofilina"], severity: "moderado", desc: "Imipenem pode reduzir limiar convulsivo — cautela." },
  ],
  "ertapenem": [
    { drugs: ["ácido valproico", "valproato"], severity: "grave", desc: "Redução de 40-60% dos níveis de valproato — risco de convulsões." },
    { drugs: ["probenecida"], severity: "moderado", desc: "Probenecida aumenta meia-vida — evitar combinação." },
  ],
  "doripenem": [
    { drugs: ["ácido valproico", "valproato"], severity: "grave", desc: "Carbapenêmicos reduzem valproato drasticamente — contraindicado." },
    { drugs: ["probenecida"], severity: "moderado", desc: "Aumenta exposição ao doripenem." },
  ],

  // ── Glicopeptídeos ──
  "vancomicina": [
    { drugs: ["gentamicina", "amicacina", "tobramicina"], severity: "grave", desc: "Nefrotoxicidade e ototoxicidade sinérgicas — monitorar função renal e audiometria." },
    { drugs: ["anfotericina b"], severity: "grave", desc: "Nefrotoxicidade aditiva grave — evitar se possível." },
    { drugs: ["furosemida"], severity: "moderado", desc: "Ototoxicidade aditiva com diuréticos de alça." },
    { drugs: ["piperacilina/tazobactam"], severity: "moderado", desc: "Risco aumentado de IRA — monitorar creatinina diariamente." },
    { drugs: ["colistina", "polimixina b"], severity: "grave", desc: "Nefrotoxicidade aditiva grave — monitorar creatinina 2x/dia." },
    { drugs: ["ciclosporina", "tacrolimus"], severity: "grave", desc: "Nefrotoxicidade aditiva — monitorar níveis e creatinina." },
    { drugs: ["cisplatina"], severity: "grave", desc: "Nefrotoxicidade e ototoxicidade sinérgicas." },
    { drugs: ["rocurônio", "vecurônio", "atracúrio"], severity: "moderado", desc: "Potencialização do bloqueio neuromuscular." },
    { drugs: ["varfarina"], severity: "moderado", desc: "Pode potencializar efeito anticoagulante — monitorar INR." },
    { drugs: ["metformina"], severity: "moderado", desc: "Risco de acúmulo de metformina se nefrotoxicidade — monitorar função renal." },
  ],
  "teicoplanina": [
    { drugs: ["gentamicina", "amicacina", "tobramicina"], severity: "grave", desc: "Nefrotoxicidade e ototoxicidade aditivas." },
    { drugs: ["anfotericina b"], severity: "grave", desc: "Nefrotoxicidade aditiva." },
    { drugs: ["furosemida"], severity: "moderado", desc: "Ototoxicidade aditiva." },
    { drugs: ["ciclosporina", "tacrolimus"], severity: "moderado", desc: "Nefrotoxicidade aditiva — monitorar função renal e níveis." },
  ],

  // ── Polimixinas ──
  "colistina": [
    { drugs: ["vancomicina"], severity: "grave", desc: "Nefrotoxicidade aditiva grave — monitorar creatinina 2x/dia." },
    { drugs: ["gentamicina", "amicacina", "tobramicina"], severity: "grave", desc: "Nefrotoxicidade e neurotoxicidade sinérgicas — evitar." },
    { drugs: ["anfotericina b"], severity: "grave", desc: "Nefrotoxicidade aditiva extrema — contraindicado se possível." },
    { drugs: ["furosemida"], severity: "moderado", desc: "Desidratação agrava nefrotoxicidade — manter hidratação." },
    { drugs: ["ciclosporina", "tacrolimus"], severity: "grave", desc: "Nefrotoxicidade sinérgica — monitorar rigorosamente." },
    { drugs: ["rocurônio", "atracúrio", "succinilcolina"], severity: "grave", desc: "Bloqueio neuromuscular aditivo — risco de apneia." },
    { drugs: ["cisplatina"], severity: "grave", desc: "Nefrotoxicidade aditiva — evitar." },
  ],
  "polimixina b": [
    { drugs: ["vancomicina"], severity: "grave", desc: "Nefrotoxicidade aditiva grave." },
    { drugs: ["gentamicina", "amicacina", "tobramicina"], severity: "grave", desc: "Nefrotoxicidade e neurotoxicidade sinérgicas." },
    { drugs: ["anfotericina b"], severity: "grave", desc: "Nefrotoxicidade aditiva extrema." },
    { drugs: ["furosemida"], severity: "moderado", desc: "Desidratação agrava nefrotoxicidade." },
    { drugs: ["rocurônio", "atracúrio", "succinilcolina"], severity: "grave", desc: "Bloqueio neuromuscular — risco de paralisia respiratória." },
    { drugs: ["ciclosporina"], severity: "grave", desc: "Nefrotoxicidade sinérgica." },
  ],

  // ── Antifúngicos sistêmicos ──
  "anfotericina b": [
    { drugs: ["gentamicina", "amicacina", "tobramicina"], severity: "grave", desc: "Nefrotoxicidade sinérgica grave — evitar combinação." },
    { drugs: ["vancomicina"], severity: "grave", desc: "Nefrotoxicidade aditiva." },
    { drugs: ["colistina", "polimixina b"], severity: "grave", desc: "Nefrotoxicidade extrema — contraindicado." },
    { drugs: ["ciclosporina", "tacrolimus"], severity: "grave", desc: "Nefrotoxicidade aditiva — monitorar creatinina diariamente." },
    { drugs: ["furosemida", "hidroclorotiazida"], severity: "grave", desc: "Hipocalemia grave aditiva — monitorar K+ e Mg2+." },
    { drugs: ["digoxina"], severity: "grave", desc: "Hipocalemia por anfotericina potencializa toxicidade digitálica." },
    { drugs: ["corticosteroides", "dexametasona", "hidrocortisona"], severity: "grave", desc: "Hipocalemia aditiva grave." },
    { drugs: ["flucitosina"], severity: "grave", desc: "Anfotericina aumenta nefrotoxicidade e níveis de flucitosina — monitorar." },
    { drugs: ["cisplatina"], severity: "grave", desc: "Nefrotoxicidade sinérgica grave." },
    { drugs: ["zidovudina"], severity: "moderado", desc: "Mielotoxicidade aditiva." },
  ],
  "fluconazol": [
    { drugs: ["varfarina"], severity: "grave", desc: "Inibe CYP2C9 — aumento significativo do INR. Monitorar." },
    { drugs: ["glibenclamida", "gliclazida"], severity: "grave", desc: "Inibição CYP2C9 — hipoglicemia grave." },
    { drugs: ["fenitoína"], severity: "grave", desc: "Inibe CYP2C9 — aumento de níveis de fenitoína." },
    { drugs: ["ciclosporina", "tacrolimus"], severity: "grave", desc: "Inibe CYP3A4 — aumento significativo de imunossupressores." },
    { drugs: ["rifampicina"], severity: "moderado", desc: "Rifampicina reduz níveis de fluconazol." },
    { drugs: ["midazolam", "triazolam"], severity: "grave", desc: "Inibição CYP3A4 — sedação prolongada." },
    { drugs: ["sinvastatina", "atorvastatina"], severity: "grave", desc: "Risco de rabdomiólise — evitar ou reduzir estatina." },
    { drugs: ["amiodarona"], severity: "grave", desc: "Prolongamento QT aditivo." },
    { drugs: ["carbamazepina"], severity: "moderado", desc: "Fluconazol aumenta níveis de carbamazepina." },
    { drugs: ["celecoxibe"], severity: "moderado", desc: "Inibição CYP2C9 — aumento de celecoxibe." },
  ],
  "voriconazol": [
    { drugs: ["rifampicina"], severity: "grave", desc: "Contraindicado — rifampicina reduz voriconazol em 96%." },
    { drugs: ["carbamazepina"], severity: "grave", desc: "Contraindicado — reduz drasticamente níveis de voriconazol." },
    { drugs: ["efavirenz"], severity: "grave", desc: "Contraindicado — redução mútua de níveis." },
    { drugs: ["sinvastatina", "atorvastatina", "lovastatina"], severity: "grave", desc: "Inibição CYP3A4 — risco de rabdomiólise." },
    { drugs: ["ciclosporina", "tacrolimus", "sirolimus"], severity: "grave", desc: "Aumento de 2-3x dos níveis — reduzir dose de imunossupressor 50%." },
    { drugs: ["midazolam", "triazolam"], severity: "grave", desc: "Sedação prolongada — contraindicado." },
    { drugs: ["varfarina"], severity: "grave", desc: "Inibição CYP2C9 — aumento significativo de INR." },
    { drugs: ["omeprazol"], severity: "moderado", desc: "Voriconazol aumenta níveis de omeprazol — reduzir dose de IBP." },
    { drugs: ["fenitoína"], severity: "grave", desc: "Interação complexa — fenitoína reduz voriconazol e voriconazol aumenta fenitoína." },
    { drugs: ["metadona"], severity: "grave", desc: "Aumento de níveis de metadona — risco de QT longo e sedação." },
  ],
  "itraconazol": [
    { drugs: ["sinvastatina", "atorvastatina", "lovastatina"], severity: "grave", desc: "Contraindicado — rabdomiólise por inibição CYP3A4." },
    { drugs: ["midazolam", "triazolam"], severity: "grave", desc: "Contraindicado — sedação prolongada." },
    { drugs: ["ciclosporina", "tacrolimus"], severity: "grave", desc: "Inibição CYP3A4 — aumento perigoso de imunossupressores." },
    { drugs: ["digoxina"], severity: "grave", desc: "Inibição P-gp — aumenta digoxinemia significativamente." },
    { drugs: ["varfarina"], severity: "moderado", desc: "Pode aumentar INR — monitorar." },
    { drugs: ["rifampicina"], severity: "grave", desc: "Rifampicina reduz itraconazol a níveis subterapêuticos." },
    { drugs: ["omeprazol", "pantoprazol"], severity: "moderado", desc: "IBPs reduzem absorção de itraconazol — tomar com acidificante." },
    { drugs: ["carbamazepina", "fenitoína"], severity: "grave", desc: "Indutores reduzem níveis de itraconazol drasticamente." },
    { drugs: ["rivaroxabana", "apixabana"], severity: "grave", desc: "Inibição CYP3A4/P-gp — risco hemorrágico." },
    { drugs: ["busulfano"], severity: "moderado", desc: "Itraconazol reduz clearance de busulfano — monitorar." },
  ],
  "posaconazol": [
    { drugs: ["sinvastatina", "atorvastatina"], severity: "grave", desc: "Contraindicado — rabdomiólise." },
    { drugs: ["ciclosporina", "tacrolimus", "sirolimus"], severity: "grave", desc: "Aumento perigoso de imunossupressores — reduzir dose 50-75%." },
    { drugs: ["midazolam"], severity: "grave", desc: "Sedação prolongada — contraindicado." },
    { drugs: ["rifampicina", "fenitoína", "carbamazepina"], severity: "grave", desc: "Reduzem níveis de posaconazol — evitar." },
    { drugs: ["metoclopramida"], severity: "moderado", desc: "Pode reduzir absorção de posaconazol." },
    { drugs: ["alcaloides do ergot", "ergotamina"], severity: "grave", desc: "Contraindicado — vasoespasmo e isquemia." },
  ],
  "caspofungina": [
    { drugs: ["ciclosporina"], severity: "moderado", desc: "Ciclosporina aumenta AUC de caspofungina 35% — monitorar hepatotoxicidade." },
    { drugs: ["tacrolimus"], severity: "moderado", desc: "Caspofungina reduz níveis de tacrolimus 20% — monitorar." },
    { drugs: ["rifampicina", "fenitoína", "carbamazepina", "dexametasona"], severity: "moderado", desc: "Indutores reduzem níveis de caspofungina — considerar aumento de dose para 70mg/dia." },
    { drugs: ["efavirenz", "nevirapina"], severity: "moderado", desc: "Podem reduzir níveis de caspofungina." },
  ],
  "micafungina": [
    { drugs: ["sirolimus"], severity: "moderado", desc: "Micafungina aumenta AUC de sirolimus 21% — monitorar níveis." },
    { drugs: ["nifedipino"], severity: "moderado", desc: "Aumento de exposição ao nifedipino — monitorar PA." },
    { drugs: ["itraconazol"], severity: "moderado", desc: "Aumento de exposição ao itraconazol." },
    { drugs: ["anfotericina b"], severity: "moderado", desc: "Nefrotoxicidade e hepatotoxicidade aditivas — evitar combinação." },
  ],
  "flucitosina": [
    { drugs: ["anfotericina b"], severity: "grave", desc: "Anfotericina aumenta nefrotoxicidade e acúmulo de flucitosina — monitorar níveis." },
    { drugs: ["zidovudina"], severity: "moderado", desc: "Mielossupressão aditiva." },
    { drugs: ["citarabina"], severity: "grave", desc: "Citarabina antagoniza efeito antifúngico da flucitosina." },
    { drugs: ["fenitoína"], severity: "moderado", desc: "Pode alterar níveis de fenitoína — monitorar." },
  ],
  "terbinafina": [
    { drugs: ["codeína", "tramadol"], severity: "moderado", desc: "Terbinafina inibe CYP2D6 — reduz conversão de codeína em morfina e altera metabolismo de tramadol." },
    { drugs: ["fluoxetina", "paroxetina"], severity: "moderado", desc: "Inibição aditiva de CYP2D6." },
    { drugs: ["ciclosporina"], severity: "moderado", desc: "Terbinafina pode reduzir níveis de ciclosporina." },
