...
export const infectiousFullProtocols7: FullProtocol[] = [
  {
    ...
    sections: [
      ...
      },
      {
            ...
            "content": "Diferenciais de Tetano."
      },
      {
            "id": "conduct",
    ...
    categoryId: "infectious",
    category: "Infectologia de Emergencia",
    tags: ["botulismo", "paralisia", "toxina", "antitoxina"],
    sections: [
      {
            "id": "intro",
            "title": "Introducao",
      ...
      },
      {
            "id": "def",
            "title": "Definicao",
            "content": "Definicao clinica e classificacao de Botulismo."
      },
      {
            "id": "screening",
            "title": "Rastreamento e Identificacao",
            "content": "Criterios de rastreamento de Botulismo."
      },
      {
            "id": "etiology",
            "title": "Etiologia",
            "content": "Causas e fatores de risco para Botulismo."
      },
      {
            "id": "clinical",
            "title": "Apresentacao Clinica",
            "content": "Sinais e sintomas de Botulismo."
      },
      {
            "id": "diagnosis",
            "title": "Diagnostico",
      ...
      },
      {
            "id": "differential",
            "title": "Diagnostico Diferencial",
            "content": "Diferenciais de Botulismo."
      },
      {
            "id": "conduct",
            "title": "Conduta Inicial",
      ...
      },
      {
            "id": "treatment",
            "title": "Abordagem Terapeutica",
            "content": "Tratamento de Botulismo."
      },
      {
            "id": "prescriptions",
            "title": "Prescricoes",
