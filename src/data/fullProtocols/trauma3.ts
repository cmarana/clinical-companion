...
export const traumaFullProtocols3: FullProtocol[] = [
  {
    ...
    sections: [
      { id: "intro", title: "Introdução", content: "A fratura pélvica é marcador de trauma de alta energia, com mortalidade de 5-20% (até 50% em instáveis). A hemorragia é a principal causa de óbito. Estabilização precoce com cinta pélvica e controle de sangramento são críticos." },
      { id: "def", title: "Definição", content: "Fraturas classificadas por Young-Burgess: compressão lateral (mais comum), compressão anteroposterior (livro aberto), cisalhamento vertical. Instabilidade hemodinâmica: fonte de sangramento massivo (plexo venoso pré-sacral, artérias ilíacas internas)." },
      ...
      { id: "treatment", title: "Abordagem Terapêutica", content: "1. Cinta pélvica (nível dos trocânteres) — fecha o anel pélvico, reduz volume e sangramento; 2. Protocolo de transfusão maciça; 3. Ácido tranexâmico 1g IV; 4. Angioembolização se instável com sangramento arterial (blush na TC); 5. Packing pré-peritoneal se falha; 6. Fixação externa de emergência." },
      { id: "prescriptions", title: "Prescrições", content: "1. Cinta pélvica imediata (lençol ou dispositivo comercial); 2. Ringer Lactato aquecido 37°C; 3. Protocolo de transfusão maciça CH:PFC:PLQ 1:1:1; 4. Ácido tranexâmico 1g IV bolus + 1g em 8h; 5. Cefazolina 2g IV; 6. Cateter vesical (se sem sangue no meato); 7. Monitorização em UTI." },
      ...
      { id: "references", title: "Referências Bibliográficas", content: "ATLS 10th Edition. Tile M. Fractures of the Pelvis and Acetabulum. ACS TQIP — Pelvic Fracture Management Guidelines." }
    ]
  },
  {
