...
export const cardioFullProtocols8: FullProtocol[] = [
  ...
  },
  {
    ...
    sections: [
      { id: "def", title: "Definição", content: "Definição clínica, classificação e epidemiologia de Endocardite Infecciosa - Protocolo" },
      { id: "screening", title: "Rastreamento e Identificação", content: "Rastreamento e identificação precoce:\\\\n• Fatores de risco para Endocardite Infecciosa - Protocolo Com" },
      { id: "etiology", title: "Etiologia", content: "Etiologia e fisiopatologia de Endocardite Infecciosa - Protocolo Completo:\\\\n• Causas primá" },
      { id: "clinical", title: "Apresentação Clínica", content: "Apresentação clínica de Endocardite Infecciosa - Protocolo Completo:\\\\n• Sintomas cardina" },
      { id: "diagnosis", title: "Diagnóstico", content: "Investigação diagnóstica para Endocardite Infecciosa - Protocolo Completo:\\\\n• Exames laboratoriais (h" },
      { id: "differential", title: "Diagnóstico Diferencial", content: "Diagnóstico diferencial de Endocardite Infecciosa - Protocolo Completo:\\\\n• Condições que mi" },
      { id: "conduct", title: "Conduta Inicial", content: "Conduta inicial para Endocardite Infecciosa - Protocolo Completo:\\\\n• Estabilização (ABCDE)\\\\n• Mon" },
      { id: "treatment", title: "Abordagem Terapêutica", content: "Abordagem terapêutica de Endocardite Infecciosa - Protocolo Completo:\\\\n• Tratamento farmacológic" },
      { id: "prescriptions", title: "Prescrições", content: "Prescrições-modelo para Endocardite Infecciosa - Protocolo Completo:\\\\n• Esquema completo com doses, vias, intervalos e duração\\\\n• Prescrição de internação\\\\n• Prescrição ambulatorial\\\\n• Ajustes para insuficiência renal/hepática\\\\n• Ajustes para idosos e gestantes\\\\n• Interações medicamentosas relevantes\\\\n• Monitorização laboratorial durante tratamento" }
    ]
      },
      {
            "id": "def",
