...
export const COVERAGE_MASTER: CoverageEntry[] = [
  ...
  { expectedId: "fp-bradiarritmia", title: "Bradiarritmias e BAV avançado", sectors: ["emergencia","ps","uti"], priority: "P1", targetYear: 2025, expectedSocieties: ["AHA","ESC"], guidelineHint: "ACC/AHA Bradycardia 2018 + ESC Pacing 2021" },
  ...
  { expectedId: "fp-fa-aguda", title: "Fibrilação Atrial aguda — controle de FC/ritmo + anticoagulação", sectors: ["emergencia","ps","uti"], priority: "P2", targetYear: 2025, expectedSocieties: ["ESC","AHA"], guidelineHint: "ESC AF 2024" },
  ...
  { expectedId: "fp-hemoptise-macica", title: "Hemoptise Maciça — proteção de via aérea + arteriografia", sectors: ["emergencia","uti","cti"], priority: "P1", targetYear: 2025, expectedSocieties: ["ATS","BTS"], guidelineHint: "ATS Massive Hemoptysis 2020" },
  ...
  { expectedId: "fp-weaning", title: "Desmame da Ventilação Mecânica (TRE/SAT/SBT)", sectors: ["uti","cti"], priority: "P2", targetYear: 2025, expectedSocieties: ["ATS","ERS"], guidelineHint: "ATS/ACCP Liberation 2017 + 2024 update" },
  ...
  { expectedId: "fp-bronquiolite", title: "Bronquiolite Viral Aguda — pediatria", sectors: ["emergencia","ps","upa","uti"], priority: "P2", targetYear: 2025, expectedSocieties: ["AAP","SBP"], guidelineHint: "AAP Bronchiolitis 2014 + SBP 2024" },
  ...
  { expectedId: "fp-dengue", title: "Dengue — estratificação A/B/C/D + hidratação", sectors: ["emergencia","ps","upa","uti"], priority: "P1", targetYear: 2026, expectedSocieties: ["MS Brasil","OPAS"], guidelineHint: "MS Diretrizes Dengue 2024" },
  { expectedId: "fp-chikungunya", title: "Chikungunya — manejo agudo e subagudo", sectors: ["emergencia","ps","upa"], priority: "P2", targetYear: 2026, expectedSocieties: ["MS Brasil","OPAS"], guidelineHint: "MS Chikungunya 2024" },
  { expectedId: "fp-malaria-grave", title: "Malária Grave — artesunato EV", sectors: ["emergencia","uti","ps"], priority: "P1", targetYear: 2025, expectedSocieties: ["WHO","MS Brasil"], guidelineHint: "WHO Malaria 2023 + MS 2024" },
  { expectedId: "fp-leptospirose-grave", title: "Leptospirose Grave (Síndrome de Weil)", sectors: ["emergencia","uti","ps"], priority: "P1", targetYear: 2025, expectedSocieties: ["MS Brasil","WHO"], guidelineHint: "MS Leptospirose 2024" },
  { expectedId: "fp-tetano", title: "Tétano Acidental — profilaxia e tratamento", sectors: ["emergencia","ps","upa"], priority: "P2", targetYear: 2025, expectedSocieties: ["MS Brasil","CDC"], guidelineHint: "MS Tétano 2023" },
  ...
  { expectedId: "fp-coma", title: "Coma — abordagem AEIOU-TIPS", sectors: ["emergencia","uti","ps"], priority: "P1", targetYear: 2025, expectedSocieties: ["AAN"], guidelineHint: "AAN Coma 2024" },
  ...
  { expectedId: "fp-delirium-uti", title: "Delirium em UTI (CAM-ICU/ICDSC)", sectors: ["uti","cti"], priority: "P2", targetYear: 2025, expectedSocieties: ["SCCM"], guidelineHint: "PADIS 2018 + SCCM 2024 update" },
  ...
  { expectedId: "fp-coma-mixedematoso", title: "Coma Mixedematoso", sectors: ["emergencia","uti","ps"], priority: "P1", targetYear: 2024, expectedSocieties: ["ATA"], guidelineHint: "ATA Hypothyroidism 2024" },
  ...
  { expectedId: "fp-hiponatremia-grave", title: "Hiponatremia Grave / Sintomática (NaCl 3%)", sectors: ["emergencia","uti","ps"], priority: "P1", targetYear: 2025, expectedSocieties: ["ESE","ERA-EDTA"], guidelineHint: "ESE Hyponatremia 2014 + 2024 update" },
  { expectedId: "fp-hipernatremia", title: "Hipernatremia Grave — correção segura", sectors: ["uti","ps","emergencia"], priority: "P2", targetYear: 2024, expectedSocieties: ["KDIGO"], guidelineHint: "KDIGO 2024" },
  ...
  { expectedId: "fp-hipocalemia", title: "Hipocalemia Sintomática — reposição EV", sectors: ["emergencia","uti","ps"], priority: "P2", targetYear: 2024, expectedSocieties: ["KDIGO"], guidelineHint: "KDIGO 2024" },
  ...
  { expectedId: "fp-isquemia-mesenterica", title: "Isquemia Mesentérica Aguda", sectors: ["emergencia","uti","ps"], priority: "P1", targetYear: 2024, expectedSocieties: ["WSES","AGA"], guidelineHint: "WSES 2024" },
  ...
  { expectedId: "fp-tev-profilaxia-uti", title: "Profilaxia de TEV em UTI (CHEST 2024)", sectors: ["uti","cti"], priority: "P2", targetYear: 2024, expectedSocieties: ["CHEST","ASH"], guidelineHint: "CHEST 2024" },
  { expectedId: "fp-anemia-falciforme-crise", title: "Crise Vaso-oclusiva em Falcêmico", sectors: ["emergencia","ps","upa"], priority: "P2", targetYear: 2024, expectedSocieties: ["ASH","MS Brasil"], guidelineHint: "ASH SCD 2020 + MS 2024" },
  ...
  { expectedId: "fp-afogamento", title: "Afogamento (SOBRASA 2024)", sectors: ["emergencia","uti","ps"], priority: "P1", targetYear: 2024, expectedSocieties: ["SOBRASA","ILCOR"], guidelineHint: "SOBRASA 2024" },
  { expectedId: "fp-hipotermia", title: "Hipotermia Acidental — reaquecimento", sectors: ["emergencia","uti","ps"], priority: "P2", targetYear: 2024, expectedSocieties: ["WMS","AHA"], guidelineHint: "WMS Hypothermia 2024" },
  ...
  { expectedId: "fp-tox-digoxina", title: "Intoxicação Digitálica — Anticorpos Fab", sectors: ["emergencia","uti","ps"], priority: "P1", targetYear: 2024, expectedSocieties: ["AAPCC"], guidelineHint: "AAPCC 2024" },
  ...
  { expectedId: "fp-ecmo", title: "Indicações de ECMO (EOLIA / ELSO)", sectors: ["uti","cti"], priority: "P2", targetYear: 2024, expectedSocieties: ["ELSO"], guidelineHint: "ELSO 2024" },
  ...
  { expectedId: "fp-sepse-pediatrica", title: "Sepse Pediátrica (Phoenix Criteria 2024)", sectors: ["emergencia","ps","uti","upa"], priority: "P1", targetYear: 2024, expectedSocieties: ["SCCM","SSC"], guidelineHint: "SSC Pediatric 2020 + Phoenix 2024" },
  { expectedId: "fp-sepse-neonatal", title: "Sepse Neonatal Precoce/Tardia", sectors: ["emergencia","uti"], priority: "P1", targetYear: 2024, expectedSocieties: ["AAP","SBP"], guidelineHint: "AAP 2024" },
  { expectedId: "fp-asma-pediatrica-grave", title: "Asma Pediátrica Grave", sectors: ["emergencia","ps","upa","uti"], priority: "P1", targetYear: 2025, expectedSocieties: ["GINA","SBP"], guidelineHint: "GINA 2025" },
  ...
  { expectedId: "fp-desidratacao-pediatrica", title: "Desidratação Pediátrica — Plano A/B/C", sectors: ["emergencia","ps","upa"], priority: "P1", targetYear: 2025, expectedSocieties: ["MS Brasil","WHO","SBP"], guidelineHint: "MS Diarreia 2024" },
  { expectedId: "fp-avc-pediatrico", title: "AVC Pediátrico", sectors: ["emergencia","uti"], priority: "P2", targetYear: 2024, expectedSocieties: ["AHA/ASA"], guidelineHint: "AHA Pediatric Stroke 2024" },
  ...
  { expectedId: "fp-angioedema", title: "Angioedema (histaminérgico vs. bradicininérgico)", sectors: ["emergencia","ps","upa"], priority: "P2", targetYear: 2024, expectedSocieties: ["WAO","HAEi"], guidelineHint: "WAO/EAACI 2024" },
  ...
  { expectedId: "fp-risco-suicidio", title: "Avaliação de Risco de Suicídio (Columbia)", sectors: ["emergencia","ps","upa"], priority: "P1", targetYear: 2024, expectedSocieties: ["MS Brasil","ABP"], guidelineHint: "MS Suicídio 2024" },
  ...
  { expectedId: "fp-lombalgia-red-flags", title: "Lombalgia Aguda — Red Flags", sectors: ["ps","upa"], priority: "P3", targetYear: 2024, expectedSocieties: ["NICE","ACP"], guidelineHint: "NICE 2024" },
];
