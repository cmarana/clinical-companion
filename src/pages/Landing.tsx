...
const features = [
  ...
  { icon: Pill, title: "1.700+ Medicamentos", desc: "Doses, diluições, interações, ajustes renais e hepáticos. Bulário completo no bolso.", accent: "bg-emerald-500/10 text-emerald-500" },
  { icon: BookOpen, title: "1.350+ Protocolos", desc: "Protocolos clínicos baseados em evidência com níveis de recomendação e referências.", accent: "bg-cyan-500/10 text-cyan-500" },
...
const allModules = [
  ...
  { icon: Pill, title: "1.700+ Medicamentos", desc: "Doses, diluições, interações, ajuste renal/hepático", color: "text-emerald-500 bg-emerald-500/10" },
  { icon: BookOpen, title: "1.350+ Protocolos", desc: "26 categorias com referências e níveis de evidência", color: "text-cyan-500 bg-cyan-500/10" },
  ...
  { icon: Timer, title: "Timer de PCR (ACLS)", desc: "Ciclos de 2 min com alertas sonoros", color: "text-red-400 bg-red-400/10" },
  { icon: ListChecks, title: "Checklists", desc: "IOT, ATLS, Sepse — passo a passo", color: "text-teal-500 bg-teal-500/10" },
  { icon: FlaskConical, title: "Diluições IV", desc: "Matriz de compatibilidade em Y", color: "text-violet-500 bg-violet-500/10" },
  { icon: Baby, title: "Doses Pediátricas", desc: "Cálculo automático por peso e idade", color: "text-pink-500 bg-pink-500/10" },
  { icon: Stethoscope, title: "Diagnóstico por Sintoma", desc: "Guias de diagnóstico diferencial", color: "text-sky-500 bg-sky-500/10" },
  { icon: ScrollText, title: "Evoluções Médicas", desc: "SOAP, I-PASS, UTI, Pediatria, Psiquiatria", color: "text-orange-500 bg-orange-500/10" },
  { icon: Mic, title: "Evolução por Voz", desc: "Dite evoluções e gere documentos clínicos", color: "text-fuchsia-500 bg-fuchsia-500/10" },
  { icon: Beaker, title: "Valores Laboratoriais", desc: "Referências com alertas de valores críticos", color: "text-lime-500 bg-lime-500/10" },
  { icon: Layers, title: "Guia Antimicrobiano", desc: "ATB por foco infeccioso e patógeno", color: "text-green-500 bg-green-500/10" },
  { icon: Search, title: "Busca CID-10", desc: "Pesquise códigos por nome ou número", color: "text-slate-500 bg-slate-500/10" },
  { icon: Activity, title: "Interações Medicamentosas", desc: "Verificação cruzada entre fármacos", color: "text-red-300 bg-red-300/10" },
  { icon: Eye, title: "Atlas Clínico", desc: "Imagens de referência por especialidade", color: "text-cyan-400 bg-cyan-400/10" },
...
const stats = [
  { value: "1.700+", label: "Medicamentos", icon: Pill },
  { value: "1.350+", label: "Protocolos", icon: BookOpen },
      ...
      <section ref={heroRef} className="relative pt-16 sm:pt-24 pb-20 px-4 overflow-hidden">
        ...
        >
          ...
          >
            ...
            Protocolos, IA clínica multimodal, calculadoras e 1.700+ fármacos —{" "}
