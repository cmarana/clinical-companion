...
const features = [
  ...
  { icon: Pill, title: "1.800+ Medicamentos", desc: "Doses, diluições, interações, ajustes renais e hepáticos. Bulário completo no bolso.", accent: "bg-emerald-500/10 text-emerald-500" },
  { icon: BookOpen, title: "1.450+ Protocolos", desc: "Protocolos clínicos baseados em evidência com níveis de recomendação e referências.", accent: "bg-cyan-500/10 text-cyan-500" },
...
const allModules = [
  ...
  { icon: Pill, title: "1.800+ Medicamentos", desc: "Doses, diluições, interações, ajuste renal/hepático", color: "text-emerald-500 bg-emerald-500/10" },
  { icon: BookOpen, title: "1.450+ Protocolos", desc: "26 categorias com referências e níveis de evidência", color: "text-cyan-500 bg-cyan-500/10" },
...
const stats = [
  { value: "1.800+", label: "Medicamentos", icon: Pill },
  { value: "1.450+", label: "Protocolos", icon: BookOpen },
      ...
      <section ref={heroRef} className="relative pt-16 sm:pt-24 pb-20 px-4 overflow-hidden">
        ...
        >
          ...
          >
            ...
            Protocolos, IA clínica multimodal, calculadoras e 1.800+ fármacos —{" "}
