...
const colorMap: Record<Compat, string> = {
  C: "bg-primary0/20 text-primary dark:text-primary",
  I: "bg-destructive0/20 text-destructive dark:text-destructive",
  "?": "bg-destructive0/10 text-destructive dark:text-destructive",
    ...
    <>
      ...
      <div className="px-4 py-4 max-w-lg md:max-w-3xl lg:max-w-5xl mx-auto space-y-4 pb-24">
        ...
        <div className="flex gap-1.5 flex-wrap">
          <span className="flex items-center gap-1 text-[10px]"><span className="w-3 h-3 rounded bg-primary0/30 inline-block" /> Compatível</span>
          <span className="flex items-center gap-1 text-[10px]"><span className="w-3 h-3 rounded bg-destructive0/30 inline-block" /> Incompatível</span>
          <span className="flex items-center gap-1 text-[10px]"><span className="w-3 h-3 rounded bg-destructive0/20 inline-block" /> Sem dados</span>
        </div>
