...
const difficultyColors = {
  "básico": "bg-primary/10 text-primary dark:text-primary border-primary/30",
  "intermediário": "bg-destructive/10 text-destructive dark:text-destructive border-destructive/30",
  "avançado": "bg-destructive/10 text-destructive dark:text-destructive border-destructive/30",
};
                  ...
                  <div className="p-4 space-y-4">
                        ...
                        {proc.steps.map(s => (
                          <div key={s.step} className="flex gap-3">
                            ...
                            <div className="flex-1 min-w-0">
                              ...
                              {s.tip && (
                                <div className="mt-1.5 flex gap-1.5 bg-destructive/10 dark:bg-destructive/5 rounded-lg p-2">
                                  <Info size={12} className="text-destructive shrink-0 mt-0.5" />
                    ...
                    >
                      <ul className="space-y-1">
                        {proc.complications.map((c, i) => (
                          <li key={i} className="text-xs text-foreground/80 flex gap-2">
                            <AlertTriangle size={12} className="text-destructive shrink-0 mt-0.5" /> {c}
                          </li>
                        ))}
                      </ul>
                    </CollapsibleSection>
                    ...
                    <div className="flex gap-2">
                      <a
                        ...
                        className="flex-1 flex items-center justify-center gap-1.5 p-2.5 rounded-xl bg-destructive/10 text-destructive dark:text-destructive text-xs font-medium hover:bg-destructive/20 transition-colors"
                      >
