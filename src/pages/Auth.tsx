  ...
  return (
    <div className="min-h-screen bg-background overflow-y-auto">
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative px-6 pt-14 pb-8 text-center max-w-md mx-auto">
          {/* Logo */}
          <motion.div
          ...
          <motion.p
            ...
            className="text-lg font-heading font-semibold text-foreground leading-snug"
          >
            Decida em segundos.
            <br />
            <span className="text-primary">Sem margem para erro.</span>
          </motion.p>
      ...
      <div className="px-4 pb-4 max-w-md mx-auto">
        <motion.h2
          ...
          className="text-xs font-heading font-semibold text-muted-foreground uppercase tracking-widest text-center mb-4"
        >
        ...
        {!showAuthForm ? (
          ...
          >
            <Button
              ...
              className="w-full h-12 rounded-2xl text-sm font-heading font-semibold gap-2 shadow-lg shadow-primary/20"
            >
          ...
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            className="bg-card rounded-3xl ring-1 ring-border/50 shadow-xl p-5 space-y-4"
          >
