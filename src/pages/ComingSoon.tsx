...
export default function ComingSoon() {
  ...
  return (
    <div className="min-h-screen bg-[#0A0F1F] text-slate-100 flex flex-col items-center justify-center px-6 text-center">
      ...
      <div className="inline-flex items-center gap-2 rounded-full border border-primary0/30 bg-primary0/10 px-3 py-1 text-xs text-primary">
      ...
      <div className="mt-8 flex flex-wrap gap-3 justify-center">
        <Button asChild className="bg-primary0 hover:bg-primary text-[#0A0F1F] font-semibold rounded-full">
