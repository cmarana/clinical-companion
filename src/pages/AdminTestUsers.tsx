  ...
  return (
    <div className="min-h-screen bg-background pb-24">
      ...
      <div className="px-4 py-5 max-w-2xl mx-auto space-y-5">
        <div className="bg-destructive/10 border border-destructive/30 rounded-xl p-3 flex gap-2 text-xs">
                ...
                <tbody>
                  {results.map((r, i) => (
                    <tr key={i} className="border-b border-border/50">
                      ...
                      <td className={`py-1.5 ${r.status === "ok" ? "text-primary" : "text-destructive"}`}>
