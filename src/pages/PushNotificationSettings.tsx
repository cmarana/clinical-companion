      ...
      <div className="px-4 pt-3 max-w-lg mx-auto space-y-3">
        ...
        <div className="bg-card rounded-[20px] shadow-sm overflow-hidden">
          <div className={cn(
            ...
            isGranted ? "bg-primary0/10" : isDenied ? "bg-destructive/10" : "bg-primary/5"
          )}>
            <div className={cn(
              "w-10 h-10 rounded-xl flex items-center justify-center",
              isGranted ? "bg-primary0/20" : isDenied ? "bg-destructive/20" : "bg-primary/10"
            )}>
              {isGranted ? <BellRing size={20} className="text-primary0" /> :
          ...
          <div className="bg-card rounded-[20px] shadow-sm p-4 space-y-3">
            ...
            {pushSubscribed && (
              <div className="space-y-2.5 pt-2 border-t border-border/50">
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    <Shield size={14} className="text-primary0" />
                    <div>
        ...
        <div className="bg-card rounded-[20px] shadow-sm p-4">
          <div className="flex items-center gap-2 mb-3">
            <div className="w-8 h-8 rounded-xl bg-destructive0/10 flex items-center justify-center">
              <Clock size={16} className="text-destructive0" />
            </div>
            <div className="flex-1">
