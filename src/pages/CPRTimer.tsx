    ...
    <>
      ...
      <div className="px-4 py-4 max-w-lg mx-auto space-y-4 pb-24">
        ...
        <div className="space-y-2">
          ...
          <div className="grid grid-cols-2 gap-2">
            <Button variant="outline" onClick={() => logDrug("Adrenalina")} className="gap-2 h-11 border-destructive/30 text-destructive hover:bg-destructive/10">
              <Pill size={14} /> Adrenalina 1mg
            </Button>
            <Button variant="outline" onClick={() => logDrug("Amiodarona 300mg")} disabled={rhythm !== "shockable"} className="gap-2 h-11 border-primary/30 text-primary hover:bg-primary/10">
              <Pill size={14} /> Amiodarona 300mg
            </Button>
            <Button variant="outline" onClick={() => logDrug("Amiodarona 150mg")} disabled={rhythm !== "shockable"} className="gap-2 h-11 border-primary/30 text-primary hover:bg-primary/10">
              <Pill size={14} /> Amiodarona 150mg
            </Button>
            <Button variant="outline" onClick={() => logDrug("Choque aplicado")} disabled={rhythm !== "shockable"} className="gap-2 h-11 border-destructive/30 text-destructive hover:bg-destructive/10">
