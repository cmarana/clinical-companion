...
const allPrimaryModules: Module[] = [
  ...
  { label: "Bulário", sub: "1.700+ fármacos", icon: Pill, path: "/bulario", variant: "default", tags: ["all"] },
  { label: "Protocolos", sub: "1.350+ protocolos clínicos", icon: BookOpen, path: "/full-protocols", variant: "default", tags: ["all"] },
