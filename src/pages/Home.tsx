...
const allPrimaryModules: Module[] = [
  ...
  { label: "Bulário", sub: "1.500+ fármacos", icon: Pill, path: "/bulario", variant: "default", tags: ["all"] },
  { label: "Prescrições", sub: "Modelos prontos para uso", icon: ClipboardList, path: "/prescriptions", variant: "default", tags: ["all"] },
  { label: "Protocolos", sub: "1.150+ protocolos clínicos", icon: BookOpen, path: "/full-protocols", variant: "default", tags: ["all"] },
