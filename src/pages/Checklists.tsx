...
const checklistsData: ChecklistData[] = [
  ...
  {
    id: "sca-iamcsst", title: "SCA — IAM com Supra ST", subtitle: "Protocolo de reperfusão urgente",
    items: [
      { id: "sca1", text: "Ativar código infarto — registrar hora de início dos sintomas", critical: true },
      { id: "sca2", text: "ECG de 12 derivações em < 10 min da chegada", critical: true },
      { id: "sca3", text: "AAS 300mg mastigado imediato (se sem contraindicação)" },
      { id: "sca4", text: "Ticagrelor 180mg VO (ou clopidogrel 600mg se ticagrelor indisponível)" },
      { id: "sca5", text: "Heparina não fracionada 5.000 UI IV bolus" },
      { id: "sca6", text: "Nitrato SL se dor + PAS > 100 (NUNCA se IAM de VD suspeito)", critical: true },
      { id: "sca7", text: "Acesso venoso + coleta: troponina, CK-MB, hemograma, coagulograma, eletrólitos" },
      { id: "sca8", text: "Morfina 2-4mg IV se dor refratária (titular com cautela)" },
      { id: "sca9", text: "Oxigênio APENAS se SpO₂ < 90%", critical: true },
      { id: "sca10", text: "ICP primária: meta porta-balão < 90 min (< 120 min se transferência)", critical: true },
      { id: "sca11", text: "Trombolítico se ICP indisponível em < 120 min: alteplase ou tenecteplase" },
      { id: "sca12", text: "V4R se supra inferior (II, III, aVF) — excluir IAM de VD" },
      { id: "sca13", text: "Monitorização contínua — risco de FV nas primeiras 48h" },
    ],
  },
  {
    id: "sepse-grave", title: "Sepse Grave / Choque Séptico", subtitle: "Bundle SSC 1 hora",
    items: [
      { id: "sg1", text: "Reconhecer: suspeita de infecção + disfunção orgânica (SOFA ≥ 2) ou qSOFA ≥ 2", critical: true },
      { id: "sg2", text: "Lactato sérico IMEDIATO (> 2 = hipoperfusão; > 4 = choque séptico)", critical: true },
      { id: "sg3", text: "Hemoculturas × 2 antes do antibiótico (não atrasar ATB por isso)" },
      { id: "sg4", text: "Antibiótico de amplo espectro em < 1 hora do reconhecimento", critical: true },
      { id: "sg5", text: "Volume: SF 0,9% 30mL/kg IV em 3h se hipotensão ou lactato ≥ 4" },
      { id: "sg6", text: "Vasopressor (norepinefrina) se PAM < 65 mmHg após volume", critical: true },
      { id: "sg7", text: "Monitorar débito urinário (sonda vesical): meta > 0,5mL/kg/h" },
      { id: "sg8", text: "Controlar o foco (drenagem, desbridamento, remoção de cateter)" },
      { id: "sg9", text: "Hidrocortisona 200mg/dia IV se choque refratário a vasopressor" },
      { id: "sg10", text: "Glicemia alvo 140-180 mg/dL (protocolo de insulina se > 180)" },
      { id: "sg11", text: "Reavaliação do ATB em 48-72h (de-escalonamento se cultura disponível)" },
      { id: "sg12", text: "Metas: PAM ≥ 65 + lactato < 2 + diurese ≥ 0,5mL/kg/h" },
    ],
  },
  {
    id: "status-epilepticus", title: "Status Epilepticus", subtitle: "Protocolo tempo-dependente",
    items: [
      { id: "se1", text: "Registrar hora de início — cada minuto conta", critical: true },
      { id: "se2", text: "Posicionar em decúbito lateral + proteger de traumas + O₂" },
      { id: "se3", text: "Glicemia capilar IMEDIATA — tratar hipoglicemia com glicose 50%", critical: true },
      { id: "se4", text: "Tiamina 100mg IV antes da glicose (se etilista ou desnutrido)" },
      { id: "se5", text: "0-5 min: Midazolam 10mg IM (1ª linha) OU Diazepam 10mg IV", critical: true },
      { id: "se6", text: "Se sem acesso: midazolam intranasal 0,2mg/kg ou retal" },
      { id: "se7", text: "5-20 min: repetir BZD se sem resposta em 5 min" },
      { id: "se8", text: "20 min (2ª linha): Valproato IV 40mg/kg OU Levetiracetam 60mg/kg OU Fenitoína 20mg/kg", critical: true },
      { id: "se9", text: "40 min (status refratário): IOT + propofol BIC ou midazolam BIC" },
      { id: "se10", text: "EEG contínuo no status refratário — descartar status não-convulsivo" },
      { id: "se11", text: "Investigar causa: neuroimagem + PL se febre + eletrólitos + tóxicos" },
      { id: "se12", text: "Monitorar: temperatura (resfriamento se hipertermia), glicemia, PA" },
    ],
  },
  {
    id: "has-emergencia", title: "HAS Emergência", subtitle: "Emergências hipertensivas com LOA aguda",
    items: [
      { id: "has1", text: "Confirmar LOA aguda: neurológico, cardíaco, renal, aórtico", critical: true },
      { id: "has2", text: "Urgência (sem LOA): reduzir PA em horas com VO — captopril, clonidina" },
      { id: "has3", text: "Emergência (com LOA): reduzir PAM 20-25% na 1ª hora com IV", critical: true },
      { id: "has4", text: "Dissecção de aorta: esmolol IV + nitroprussiato. Meta PAS < 120 em 20 min", critical: true },
      { id: "has5", text: "AVCh: nicardipina IV. Meta PAS < 140 mmHg (ATACH-2)" },
      { id: "has6", text: "AVCi pré-tPA: labetalol IV. Meta PA < 185/110" },
      { id: "has7", text: "EAP hipertensivo: nitroglicerina IV + furosemida IV" },
      { id: "has8", text: "Eclâmpsia: hidralazina IV ou labetalol IV + MgSO₄" },
      { id: "has9", text: "Encefalopatia hipertensiva: nicardipina IV. Meta: reduzir PAM 20-25%" },
      { id: "has10", text: "NUNCA: nifedipina sublingual (queda abrupta imprevisível)", critical: true },
      { id: "has11", text: "Monitoração contínua de PA + ECG + função renal + diurese" },
    ],
  },
  {
    id: "ira-aguda", title: "Insuficiência Respiratória Aguda", subtitle: "Abordagem escalonada de oxigenação",
    items: [
      { id: "ira1", text: "Avaliar: FR, SpO₂, uso de musculatura acessória, nível de consciência", critical: true },
      { id: "ira2", text: "Posicionar sentado (45°) + O₂ suplementar titulado (meta SpO₂ ≥ 94%)" },
      { id: "ira3", text: "Identificar causa: EAP, DPOC, asma, TEP, pneumonia, SDRA" },
      { id: "ira4", text: "VNI (BiPAP/CPAP): 1ª linha se DPOC + acidose, EAP, imunossuprimido", critical: true },
      { id: "ira5", text: "CNAF (cateter nasal de alto fluxo): alternativa para hipoxemia refratária" },
      { id: "ira6", text: "Indicações de IOT: GCS ≤ 8, apneia, falha da VNI, fadiga iminente", critical: true },
      { id: "ira7", text: "Pré-oxigenar por 3-5 min com FiO₂ 100% antes da intubação" },
      { id: "ira8", text: "Sequência rápida: ketamina + succinilcolina (ou rocurônio se contraindicação)" },
      { id: "ira9", text: "VM protetora: Vt 6mL/kg peso predito + platô ≤ 30 cmH₂O" },
      { id: "ira10", text: "SDRA grave (PaO₂/FiO₂ < 150): posição prona ≥ 16h/dia" },
      { id: "ira11", text: "Gasometria arterial para guiar a estratégia ventilatória" },
    ],
  },
];
