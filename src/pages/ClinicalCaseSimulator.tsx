...
const difficulties = [
  { id: "basico", label: "Básico", desc: "Casos clássicos — 5º/6º ano", icon: BookOpen, color: "text-primary" },
  { id: "intermediario", label: "Intermediário", desc: "Comorbidades — Internato/R1", icon: Stethoscope, color: "text-destructive" },
  { id: "avancado", label: "Avançado", desc: "Casos atípicos — R2+", icon: Brain, color: "text-destructive" },
];
